...
import { key_piece_data } from "../keyPieces";
import KeyPieceCard from "./KeyPieceCard";
const About = () => {
  return (
    <div>
      <section className="text-gray-600 body-font">
        <div className="container mx-auto flex px-20 py-8 md:flex-row flex-col items-center">
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-black  font-serif">
              Always Going Above and Beyond
            </h1>
            <p className="mb-8 leading-relaxed text-lg text-black   font-serif">
              {" "}
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; An crucial tool for
      ...
      <div className="container px-5 py-8 mx-auto">
        <div className="flex flex-col bg-teal-100 pt-4 text-center w-full mb-1">
          <h1 className="sm:text-2xl mb-4 text-black font-bold font-serif ">
            Here are some of the key pieces of information that should be
            included in a bank information section
          </h1>
        </div>
      </div>
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto flex flex-wrap">
          {key_piece_data?.map((key_piece) => {
            console.log(key_piece, "key_piece")
            return <KeyPieceCard key={key_piece.ID} {...key_piece} />
          })}
        </div>
